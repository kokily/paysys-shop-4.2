...
import { UPDATE_WEDDING } from '../../../libs/graphql/expense';
  ...
  useEffect(() => {
    if (
      ...
      setInputs({
        ...
        owner_woman_husband: data.ReadWedding.company.owner_woman_husband.toString(),
        owner_woman_bride: data.ReadWedding.company.owner_woman_bride.toString(),
        owner_man_husband: data.ReadWedding.company.owner_man_husband.toString(),
        ...
        ceremony_husband: data.ReadWedding.convention.ceremony_husband.toString(),
        ...
        hanbok_pre_husband: data.ReadWedding.hanbok.hanbok_pre_husband.toString(),
        hanbok_pre_bride: data.ReadWedding.hanbok.hanbok_pre_bride.toString(),
        hanbok_post_husband: data.ReadWedding.hanbok.hanbok_post_husband.toString(),
        ...
        present_num_husband: data.ReadWedding.present.present_num_husband.toString(),
        present_num_bride: data.ReadWedding.present.present_num_bride.toString(),
