...
const ReadPresent: React.FC<Props> = ({ present }) => {
  return (
    <>
      <tr>
      ...
      <tr>
        ...
        <td className="sub">
          {stringAccounting(present.present_num_husband + present.present_num_bride)}명
        </td>
      </tr>

      <tr>
        <th>답례품 총 비용</th>
        <td>{stringAccounting(present.present_price * present.present_num_husband)}원</td>
        <td>{stringAccounting(present.present_price * present.present_num_bride)}원</td>
        <td className="sub">
          {stringAccounting(
