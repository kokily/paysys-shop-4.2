...
const ReadConvention: React.FC<Props> = ({ convention }) => {
  return (
    <>
      <tr>
        <th>구분</th>
      ...
      <tr>
        ...
        <td className="sub">
          {stringAccounting(convention.rental_husband + convention.rental_bride)}원
        </td>
      </tr>
      ...
      <tr>
        ...
        <td className="sub">
          {stringAccounting(convention.sword_husband + convention.sword_bride)}원
        </td>
      </tr>
      ...
      <tr>
        ...
        <td className="sub">
          {stringAccounting(convention.glove_husband + convention.glove_bride)}원
        </td>
      </tr>
      ...
      <tr>
        ...
        <td className="sub">
          {stringAccounting(convention.bouquet_husband + convention.bouquet_bride)}원
        </td>
      </tr>
      ...
      <tr>
        ...
        <td className="sub">
          {stringAccounting(convention.ceremony_husband + convention.ceremony_bride)}원
        </td>
      </tr>
    </>
  );
